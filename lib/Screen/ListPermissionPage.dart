...
class ListPermmision extends StatefulWidget {
  const ListPermmision({super.key});

  @override
  State<ListPermmision> createState() => _ListPermmisionState();
}

class _ListPermmisionState extends State<ListPermmision> {
  @override
  void initState() {
    super.initState();
      ...
      body:     Obx(() {
        if (formController.isLoading.value) {
          ...
          return ListView.builder(
            itemCount: formController.PermissionList.length,
            itemBuilder: (context, index) {
              var item = formController.PermissionList[index];
              return Container(
                ...
                child: ListTile(
                  ...
                  title: Row(
                    ...
                    children: [
                      Text(item['EmpName'], style: GoogleFonts.poppins(
                      ...
                      Row(
                        children: [
                          ElevatedButton(
                              onPressed: () {
                                formController.ApprovePermissioncall(item['DocNo']);
                          ...
                          ElevatedButton(
                              onPressed: () {
                                ...
                                formController.CancelPermissioncall(item['DocNo']);
